# Commander Pairings for Sunset Canyon

This guide covers the best commander pairings for Sunset Canyon defense, based on community research and meta analysis.

## How Pairings Work

In Rise of Kingdoms, two commanders lead each army:

| Role | Talents | Skills | Position |
|------|---------|--------|----------|
| **Primary** | Active | Active | Determines march type |
...
| Primary | Secondary | Why It Works |
|---------|-----------|--------------|
| **Baibars** | **Saladin** | Exception to cavalry weakness - Baibars has 5-target AOE |
| **Baibars** | **Aethelflaed** | AOE + debuff combo, slowed targets take extra damage |

## A-Tier Pairings (Strong Options)

| Primary | Secondary | Why It Works |
|---------|-----------|--------------|
| **Alexander the Great** | **Guan Yu** | Shield + massive damage combo |
| **Joan of Arc** | **Charles Martel** | Buffer + tank, great survivability |
| **Joan of Arc** | **Hermann** | Solid silencer combo to counter nukers |
| **Scipio Africanus** | **Charles Martel** | Good Canyon tank, Scipio adds troop capacity |
| **Mehmed II** | **Yi Seong-Gye** | Conquering AOE, works like YSG but less damage |
| **Harald Sigurdsson** | **Sun Tzu** | Infantry damage + buff, stronger vs multiple enemies |

## B-Tier Pairings (Viable Early-Mid Game)
...
**1. Skill Damage Amplification**
```
Guan Yu silences target → Leonidas deals +50% skill damage to silenced
```

**2. Debuff + Damage Combo**
```
Aethelflaed reduces stats 30% → All damage is more effective
Baibars slows targets → Aethelflaed deals bonus to slowed targets
```

**3. Rage Generation**
```
Sun Tzu restores 250 rage → Partners spam skills faster
```

**4. Sustain Combos**
```
Richard heals → High troop count → More damage output
...
|------------|----------|----------|
| **Infantry** | Tanky, counters cavalry | Slower damage |
| **Archer** | AOE damage, skill-focused | Fragile |
| **Cavalry** | Fast, high burst | Countered by infantry (common in Canyon) |
| **Mixed** | Flexible | No specialized bonuses |

**Best for Canyon:** Infantry + Archer mix (tanks front, AOE back)

## Commander Tier List for Canyon
...
| **Guan Yu** | Damage | 3 | Massive AOE + silence |
| **Aethelflaed** | Debuff | 5 | FREE from Canyon shop, 30% stat reduction |

### A-Tier (Strong Options)

| Commander | Role | AOE | Why |
|-----------|------|-----|-----|
| **Leonidas** | Damage | 1 | +50% skill damage to silenced (pair with Guan Yu) |
| **Joan of Arc** | Support | 1 | Versatile buffer, most used epic |
| **Alexander the Great** | Tank/Damage | 1 | Shield + damage hybrid |
| **Mehmed II** | AOE | 3 | Works like YSG with less damage |
| **Artemisia I** | AOE | 3 | Better sustain than YSG |
| **Ramesses II** | Debuff | 3 | Counters healers (Richard) |
| **Wu Zetian** | Tank | 1 | Good with Constantine, counters nukers |

### B-Tier (Situational)

| Commander | Role | AOE | Why |
|-----------|------|-----|-----|
| **Hermann** | Anti-Nuker | 1 | Silence + rage reduction |
| **Scipio Africanus** | Tank | 1 | Troop capacity, healing |
| **Eulji Mundeok** | Debuff | 1 | Defense reduction |
| **Bjorn Ironside** | Damage | 1 | Epic infantry with skill boost |
| **Baibars** | AOE | 5 | Only viable cavalry (AOE exception) |

### Avoid in Canyon

| Commander | Why |
|-----------|-----|
| Most Cavalry | Countered by infantry-heavy defenses |
| Attila/Takeda | Rally-focused, not Canyon optimized |
| Pure Gatherers | No combat value |
...
**Recommended F2P Formation:**
```
Back:  Aethelflaed/YSG  |  Sun Tzu/Joan  |  [Any AOE]  |  [Support]
Front: Charles Martel   |  Richard I     |  [Tank]
```

## Sources

- [AllClash Commander Pairings](https://www.allclash.com/)
